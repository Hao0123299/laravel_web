...
<div class="log-w3">
    <div class="w3layouts-main">
        ...
        ?>
        <form action="{{URL::to('/register-staff')}}" method="POST">
            {{ csrf_field() }}
            ...
            @endforeach
            <input type="text"  class="ggg" name="admin_name" value="{{old("admin_name")}}" placeholder="Điền tên nhân viên" >
            <input type="text"  class="ggg" name="admin_phone" value="{{old("admin_phone")}}" placeholder="Điền số điện thoại nhân viên" >

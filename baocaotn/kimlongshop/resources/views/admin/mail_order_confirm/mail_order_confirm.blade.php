        ...
        <div class="row" style="background: cadetblue;padding: 15px">
            ...
            <div class="col-md-6 logo"  style="color: #fff">
                <p>Chào quý khách
                    ...
                    đơn hàng của quý khách đã được cửa hàng chúng tôi giao. Quý khách có thể nhận trong vòng 3 - 5 ngày tùy theo khu vực. Xin cám ơn
                </p>
            </div>
            ...
            <div class="col-md-12">
                ...
                <p>Hình thức thanh toán : <strong style="text-transform: uppercase;color:#fff">
                        @if($shipping->shipping_method==0) Chuyển khoản @elseif($shipping->shipping_method==1) Tiền
                        mặt @else Thanh toán online Paypal @endif
                    </strong></p>
            ...
            <p style="color:#fff">Xem lại đơn hàng quý khách đã đặt tại cửa hàng theo đường link sau : <a target="_blank" href="{{url('/order-history')}}">Cửa hàng điện thoại Kim Long</a></p>
            <p style="color:#fff">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="http://kimlong.com/kimlongshop">Cửa hàng điện thoại Kim Long</a>, hoặc liên hệ qua số hotline : 1900.5689 để được giải đáp mọ thắc mắc.Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>

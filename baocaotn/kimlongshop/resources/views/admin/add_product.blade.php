                        ...
                        <form role="form" action="{{URL::to('/save-product')}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="length" data-validation-length="min1"
                                       data-validation-error-msg="Vui lòng điền tên sản phẩm" name="product_name"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="number"
                                       data-validation-error-msg="Vui lòng điền số lượng sản phẩm"
                            ...
                            <div class="form-group">
                                ...
                                <input
                                       type="text" data-validation="length" data-validation-length="min1"
                                       data-validation-error-msg="Vui lòng thêm số tiền" name="product_price"
                                       class="form-control product_price" id="exampleInputEmail1" placeholder="Giá bán">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Giá nhập</label>
                                <input type="text" data-validation="length"  data-validation-length="min1"
                                       data-validation-error-msg="Vui lòng thêm số tiền" name="product_price_cost"
                                       class="form-control product_price_cost" id="exampleInputEmail1"

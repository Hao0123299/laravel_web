                    ...
                    <div class="position-center">
                        <form role="form" action="{{URL::to('/insert-coupon-code')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="coupon_start" class="form-control" id="coupon_start">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Kết thúc</label>
                                <input type="text" name="coupon_end" class="form-control" id="coupon_end">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="coupon_number" class="form-control coupon_number " id="exampleInputEmail1">
                            </div>

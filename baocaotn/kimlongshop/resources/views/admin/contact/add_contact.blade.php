                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <form role="form" action="{{URL::to('/update-save/'.$con->contact_id)}}" method="post" enctype="multipart/form-data">
                            ...
                            {{--<div class="form-group">
                                <label for="exampleInputEmail1">Khẩu hiệu của cửa hàng</label>
                                <input type="text" value="{{$con->contact_slogan}}" name="contact_slogan" class="form-control" id="exampleInputEmail1">

                            ...
                            <form role="form" action="{{URL::to('/update-product/'.$pro->product_id)}}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_name" class="form-control"
                                           onkeyup="ChangeToSlug();" id="slug" value="{{$pro->product_name}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-validation="length"  data-validation-length="min1"
                                           data-validation-error-msg="Vui lòng thêm số tiền"
                                           value="{{$pro->product_price}}" name="product_price_cost"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-validation="length"  data-validation-length="min1"
                                           data-validation-error-msg="Vui lòng thêm số tiền"
                                           value="{{$pro->product_price_cost}}" name="product_price"
                                           class="form-control product_price" id="exampleInputEmail1">
                                </div>
                                <div class="form-group">

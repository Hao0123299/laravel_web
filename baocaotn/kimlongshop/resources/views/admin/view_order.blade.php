            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <tr>
                        ...
                        <td>@if($shipping->shipping_method==0) Chuyển khoản @elseif($shipping->shipping_method==1) Tiền
                            mặt @else Thanh toán online Paypal @endif</td>
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            {{--Phí ship : {{number_format($details->product_feeship,0,',','.')}} VNĐ (CỬa hàng sẽ thanh toán)--}}

...
<div class="container" style="background: peru;border-radius: 12px;padding:15px;">
    <div class="col-md-12" >
        <div class="row" style="background: cadetblue;padding: 15px">
            ...
            <p style="color:#fff">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="http://kimlong.com/kimlongshop/">Kim Long</a>, hoặc liên hệ qua số hotline : 19005689.Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>

                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" data-validation="length" data-validation-error-msg="Vui lòng thêm số tiền" value="{{$pro->product_price}}" name="product_price_cost" class="form-control product_price" id="exampleInputEmail1" >
                                </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Giá bán</label>
                                        <input type="text" data-validation="length" data-validation-error-msg="Vui lòng thêm số tiền" value="{{$pro->product_price_cost}}" name="product_price" class="form-control product_price" id="exampleInputEmail1" >
                                    </div>
                                  <div class="form-group">

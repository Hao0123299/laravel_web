    ...
    <section id="cart_items">
        <div class="container">
            ...
            <div class="register-req">
                <p>Quý khách vui lòng đăng ký hoặc đăng nhập để thanh toán giỏ hàng và xem lại lịch sử mua hàng</p>
            </div><!--/register-req-->
            ...
            <div class="shopper-informations">
                <div class="row">
                    ...
                    <div class="col-sm-12 clearfix">
                        ...
                        @endif
                        <div class="bill-to">
                            <p>Điền thông tin nhận hàng hàng</p>
                            <div class="form-one">
                                <form method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Email người nhận hàng</label>
                                        <input type="text" name="shipping_email" data-validation="length"
                                ...
                                <table class="table table-condensed">
                                    ...
                                    @if(Session::get('cart')==true)
                                                ...
                                                <td class="cart_quantity">
                                                    <div class="cart_quantity_button">
                                                        ...
                                                        <input class="cart_quantity" type="number"
                                                               @if(Session::put('paypal_suscces')==true)
                                                               readonly
                                                               @endif
                                        ...
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a class="btn btn-primary m-3" href="{{ route('processTransaction') }}">Thanh
                                                    toán PayPal</a>
                                            </td>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="5">
                                                <center>
                                                    @php
                                                        echo 'Vui lòng thêm hàng vào giỏ để thanh toán';
                                                    @endphp
                                                </center>
                                            </td>
                                        </tr>
